...
public class LoginActivity extends AppCompatActivity {
    ...
    /*
    Cada vez que queremos testear cualquier cosa en nuestra app
    tenemos que introducir usaruio y contraseña, lo que conelleva
    mucho tiempo, al final con este nos aseguramos que siempre funciona
    la lógica de interfaz de usuario, que no hay que confundir con la
    logica de que se conecte al web service y este funcione.
    Es decir aqui solo vemos que si es todo ok hace lo que debe.
     */
